...
describe('fileOps', () => {
  ...
  describe('fileExists', () => {
    ...
    it('throws and logs for other errors', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        'fileExists: could not get access to file /path/file.txt'
      )
    })
  })
  ...
  describe('ensureDir', () => {
    ...
    it('throws and logs on error', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        'ensurePath: Could not create directory /path/sub',
        error
      )
    })
  })
  ...
  describe('listDir', () => {
    ...
    it('throws if directory does not exist', async () => {
      vi.spyOn(fileSec, 'safePath').mockReturnValue('/path/sub')
      vi.spyOn(fs, 'access').mockRejectedValue({ code: 'ENOENT' })
      await expect(listDir('/path/sub')).rejects.toThrow(
        'readDir: Directory does not exist: /path/sub'
      )
    })
  ...
  describe('readFile', () => {
    ...
    it('throws if file does not exist', async () => {
      vi.spyOn(fileSec, 'safePath').mockReturnValue('/path/file.json')
      vi.spyOn(fs, 'access').mockRejectedValue({ code: 'ENOENT' })
      await expect(readFile('/path/file.json')).rejects.toThrow(
        'readFile: File does not exist: /path/file.json'
      )
  ...
  describe('saveFile', () => {
    ...
    it('throws and logs on error', async () => {
      ...
      expect(logger.error).toHaveBeenCalledWith(
        'saveFile: Could not save file: /path/file.txt :',
        error
      )
    })
  })
  ...
  describe('getFileStats', () => {
    ...
    it('returns null for ENOENT', async () => {
      ...
      expect(logger.info).toHaveBeenCalledWith(
        'getFileStats: file does not exist, returning null: /path/file.txt'
      )
