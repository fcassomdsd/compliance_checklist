...
global.window = {
  electronAPI: {
    loadChecklist: vi.fn().mockResolvedValue({
      ...
      "sequence": "00010",
      "question": "Tiene definidos el proveedor del servicio de procesamiento de datos los componentes y el alcance de la red ATN?",
      "verification": "➢Diagramas lógicos y físicos de red<br>➢ Inventario de componentes de la red ATN",
